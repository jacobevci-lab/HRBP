...
expect(modulePath, modulePage, /slug\s*===\s*"employee-relations"[\s\S]*<EmployeeRelationsCaseLifecyclePanel/, "Employee Relations module must mount case lifecycle governance");
