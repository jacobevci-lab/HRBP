...
const grants: Record<PlatformRole, Capability[]> = {
  ...
  HRBP: [
    ...
    "performance:read", "performance:write", "talent:read", "talent:write",
    "succession:read", "succession:write", "learning:read",
  ...
  TIME_ADMIN: [
    ...
    "leave:read", "leave:write", "policies:read"
  ],
  TALENT_ADMIN: [
    "people:read", "organization:read", "positions:read",
    "performance:read", "performance:write", "talent:read", "talent:write",
    "succession:read", "succession:write", "learning:read", "learning:write",
