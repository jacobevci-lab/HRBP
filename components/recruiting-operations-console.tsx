...
import { BriefcaseBusiness, CheckCircle2, CircleAlert, FileCheck2, ShieldCheck, UserPlus, UsersRound } from "lucide-react";
  ...
  return <section className="ats-console card">
    ...
    <div className="ats-ops-panel" style={{ marginBottom: 16 }}>
      ...
      <div className="ats-operation-list">
        ...
        {approvalQueue.map((item) => <div className="ats-operation" key={`${item.type}-${item.id}`}>
