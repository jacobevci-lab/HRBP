...
export async function OffboardingWorkspace() {
  ...
  try {
    ...
    const data = await getOffboardingWorkspaceData(ctx.tenantId, canWrite);
    return <div className="off-shell">
